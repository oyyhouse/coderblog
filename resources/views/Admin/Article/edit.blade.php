...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 资讯管理 <span class="c-gray en">&gt;</span> 资讯列表<span class="c-gray en">&gt;</span> 编辑修改 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <form class="form form-horizontal" id="form-article-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="title" class="input-text" placeholder="请填写标题" id="title" required="required" value="{{ $article->title }}">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>分类栏目：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="category" class="select" value="{{ $article->category }}">
                    @foreach($category as $key=>$value)
                        <option value="{{$value['id']}}"  @if( $article->category ==$value['id']) selected @endif>@if(!$value['ismain'])&nbsp;&nbsp;├─@endif{{$value['cate_name']}}</option>
                    @endforeach
                </select>
				</span> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $article->order }}" placeholder="" id="articlesort" name="order">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">关键词：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $article->keywords }}" placeholder="" id="keywords" name="keywords">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ $article->resource }}" placeholder="" id="resource" name="resource">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    @if($article->thumb)<img src="/uploads/{{$article['thumb']}}" width="250px;" height="150px;" id="old_thumb" >@endif
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:100%;height:400px;" name="body" >{!! $article->body  !!}</script>
            </div>
        </div>
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button class="btn btn-primary radius" type="submit" id="submit_save"><i class="Hui-iconfont">&#xe632;</i> 提交修改</button>
