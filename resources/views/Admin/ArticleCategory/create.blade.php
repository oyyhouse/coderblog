...
<div class="page-container">
    <form action="{{ url('admin/articleCategory') }}" method="POST"  class="form form-horizontal" id="form-category-add">
        {{ csrf_field() }}
            ...
            <div class="tabCon">
                ...
                <div class="row cl">
                 ...
                 <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="" name="keywords">
                    </div>
                    <div class="col-3">
                    </div>
                 </div>
                 <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <textarea name="description" cols="" rows="2" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,100)"></textarea>
